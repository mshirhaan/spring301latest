...
public class CustomerServiceTest {
	...
	public void createStubs() {
		customer = new Customer(1, "Mohammed", "Shirhaan", "mshirhaan", "test");
		customerDto = new CustomerDto(customer);		
	}
	
	@Test
	public void findById() {
		when(customerRepository.findById(Mockito.anyInt()))
			.thenReturn(Optional
					.of(customer));
	...
	public void registerCustomer() {
		...
		assertEquals("mshirhaan", customerTest.getUsername());
	}
	
	@Test
	public void updateCustomer_found() {
		when(customerRepository.findByIdAndIsActiveIsTrue(Mockito.anyInt()))
		.thenReturn(customer);
